...
const faq_chunk_entity_1 = require("./entities/faq-chunk.entity");
...
exports.KnowledgeBaseModule = KnowledgeBaseModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([faq_chunk_entity_1.FaqChunk])],
        providers: [faq_repository_1.FAQRepository, knowledge_base_service_1.KnowledgeBaseService],
